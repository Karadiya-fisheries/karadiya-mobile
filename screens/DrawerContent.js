        ...
        <View style={styles.drawerContent}>
          ...
          <Drawer.Section style={styles.drawerSection}>
            ...
            <DrawerItem
              ...
              onPress={() => {
                props.navigation.navigate('Fisherman-Registration');
              }}
            />
            <DrawerItem
              icon={({color, size}) => (
              ...
              label="E-logBook"
              onPress={() => {
                props.navigation.navigate('E-logBook');
              }}
            />
            <DrawerItem
              icon={({color, size}) => (
            ...
            <DrawerItem
              ...
              onPress={() => {
                props.navigation.navigate('Boat-Registration');
              }}
            />
            <DrawerItem
              icon={({color, size}) => (
              ...
              onPress={() => {
                props.navigation.navigate('Departure-Approval');
              }}
            />
          </Drawer.Section>
        </View>
