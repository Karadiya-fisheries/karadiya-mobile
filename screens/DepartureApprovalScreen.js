...
const departureapprovalValidationSchema = yup.object().shape({
  imul: yup.string().required('*This is a required field'),
  ownername: yup.string().required('*This is a required field'),
  phnum: yup.string().required('*This is a required field'),
  email: yup
    .string()
    .email('Please enter an valid email')
    .required('*This is a required field'),

  skippername: yup.string().required('*This is a required field'),
  nic: yup.string().required('*This is a required field'),
  skippernum: yup.string().required('*This is a required field'),
  mlength: yup.number().required('*This is a required field'),
  throns: yup.string().required('*This is a required field'),
  cnet: yup.string().required('*This is a required field'),
  ceye: yup.number().required('*This is a required field'),
  netting: yup.string().required('*This is a required field'),
  neteye: yup.string().required('*This is a required field'),
  psname: yup.string().required('*This is a required field'),
  psnic: yup.number().required('*This is a required field'),
  llicense: yup.string().required('*This is a required field'),
  ilicense: yup.string().required('*This is a required field'),
});
              ...
              <ProgressSteps {...progressStepsStyle}>
                <ProgressStep>
                  <View style={{flexDirection: 'column', padding: 15}}>
                    ...
                    <Text style={styles.txt}>
                      07. Skipper Number (Starts with SK or SL)
                    </Text>
                    <TextInput
                      style={styles.textInput}
                ...
                <ProgressStep>
                  <View style={{flexDirection: 'column', padding: 15}}>
                    <Text style={styles.txt}>
                      08. Port where the boat is expected to depart (select one
                      from the list)
                    </Text>
                    ...
                    <View style={{flexDirection: 'column', marginTop: 20}}>
                      <Text style={styles.txt}>
                        09. Fishing area during fishing operations
                      </Text>
                      ...
                      <View style={{flexDirection: 'row'}}>
                        <RadioButton
                          ...
                          value="indigenous"
                          status={
                            checked === 'indigenous' ? 'checked' : 'unchecked'
                          }
                    ...
                    <View style={{flexDirection: 'column'}}>
                      <Text style={styles.txt}>
                        10. Description of the carrying device
                      </Text>
                      <View
                        style={{
                          flexDirection: 'row',
                ...
                <ProgressStep>
                  <View style={{padding: 15}}>
                    <Text style={styles.txt}>
                      11. Boat Traveler Details (Fill in the number of travelers
                      only)
                    </Text>
                    <View>
                          ...
                          <View style={{flexDirection: 'column'}}>
                            ...
                            <View style={{flexDirection: 'row-reverse'}}>
                              <TouchableOpacity
                                ...
                                <Text style={{color: '#333C8D', fontSize: 15}}>
                                  Remove
                                </Text>
                              </TouchableOpacity>
                            </View>
                  ...
                  <View style={{padding: 15, marginTop: 10}}>
                    <Text style={styles.txt}>
                      12. Local Operating License Number of the Vessel
                    </Text>
                    <TextInput
                      style={styles.textInput}
                    ...
                    <Text style={styles.txt}>
                      13. International Operating License Number of the Vessel
                      (If any)
                    </Text>
                    <TextInput
                      style={styles.textInput}
                    ...
                    <Text style={styles.txt}>
                      14. Radio station and code addressed by the Vessel
                    </Text>
                    <View style={{flexDirection: 'row'}}>
                      <View
                        style={{
                    ...
                    <View style={{flexDirection: 'column', marginTop: 20}}>
                      <Text style={styles.txt}>
                        15. I have a VMS device on board and to the best of my
                        knowledge it is in working condition.
                      </Text>
                ...
                <ProgressStep onSubmit={handleSubmit} disabled={!isValid}>
                  <View style={{padding: 15, marginTop: 10}}>
                    <Text style={styles.txt}>
                      16. I will not take on this boat any of my boat's
                      registration book, operating license, valid insurance
                      certificate, log book, fire extinguishers, radio with call
                      sign, life jacket, life-saving equipment, or any other
                      means of disembarkation. I hereby promise that I will not
                      be taken on board and will not engage in any activity that
                      is detrimental to national security or the health of the
                    ...
                    <Text style={styles.txt}>
                      17. Click the button below to request the transit (check
                      if you get a message that says 'successfully forwarded'
